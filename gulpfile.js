...
function gsap_ScrollTo() {
  return (
    src("node_modules/gsap/dist/ScrollToPlugin.min.js")
      // .pipe(terser())
      .pipe(dest("vendor/gsap/"))
  );
}
...
function renameTask() {
  return src("dist/*.html").pipe(rename("index.html")).pipe(dest("."));
}
...
function copywebp() {
  return src(files.webpsimgPath).pipe(dest(files.webpsimgPathTo));
}
...
// Minify via Tinypng
exports.tiny = series(copysvgs, copygifs, copywebp, minImg);
